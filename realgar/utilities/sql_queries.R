...
ngs_db <- dbConnect(SQLite(), dbname="~/shiny_apps/shiny-server/realgar/realgar_data/realgar-omics.sqlite")

#SQLite for gwas data from database ---
gwas_db <- dbConnect(SQLite(), dbname="~/shiny_apps/shiny-server/realgar/realgar_data/realgar-gwas.sqlite")
