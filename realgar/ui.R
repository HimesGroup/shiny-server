...
ui <- shinyUI(fluidPage(theme = shinytheme("lumen"),
                        ...
                        navbarPage( "", 
                                             ...
                                             wellPanel(fluidRow(align = "left",
                                                                column(12,  
                                                                       ...
                                                                       fluidRow(div(style="margin-right: 25px", 
                                                                                    column(3, 
                                                                                           fluidRow(pickerInput("Tissue",label = strong("Tissue:"),choices = c("Structural", "Blood", "Cancer"),multiple = TRUE,width="240px",
                                                                                                    selected= c("Structural", "Blood", "Cancer"),options = list(`actions-Box` = TRUE,`none-Selected-Text` = "Select tissue type(s)"))),
                                                                                           ...
                                                                                           choices = c("Airway smooth muscle"="ASM", "Bronchial epithelium"="BE","Lens epithelium" = "LEC", "BEAS-2B" = "BEAS-2B",
                                                                                    ...
                                                                                    column(2,
                                                                                           fluidRow(checkboxGroupInput(inputId="Asthma", label=strong("Condition:"), 
                                                                                           choices=c("Allergic asthma vs healthy"="allergic_asthma", "Asthma vs healthy"="asthma",
                                                                                                     "Fatal asthma vs healthy"="fatal_asthma", "Mild to moderate asthma vs healthy"="mild_to_moderate_asthma","Severe asthma vs healthy"="severe_asthma",
                                                                                                      ...
                                                                                                      "Non-allergic asthma vs healthy"="non_allergic_asthma"),selected=c("asthma","mild_to_moderate_asthma","allergic_asthma","rhinitis_mild_asthma"))),                                                                                           
                                                                                           fluidRow(actionButton("selectall_asthma","Select all")),
                                                                                           br(),
                                                                                           fluidRow(checkboxGroupInput(inputId = "Status", label = strong("Restrict Age Group:"),choices=c("Children"="childhood","Adult"="adult"),selected="childhood"))),
                                                                                    ...
                                                                                    column(3, 
                                                                                           fluidRow(checkboxGroupInput(inputId="Treatment", label=strong("Treatment:"), 
                                                                                                                          choices = c("β2-agonist"="BA", 
                                                                                                                                      ...
                                                                                                                                      #"β2-agonist+Phosphodiesterase inhibitor"="BA_PDE",
                                                                                                                                      "Smoking"="smoking", "Vitamin D"="vitD","Glucocorticoid" = "GC"), selected=c("BA","GC","PDE"))),
                                                                                           fluidRow(actionButton("selectall_treatment","Select all")),br(),
                                                                                           fluidRow(checkboxGroupInput(inputId = "Experiment", label = strong("Select Experiment Design:"),choices=c("Cell-based assay"="invitro","Human response study"="invivo"),selected="invitro")),
                                                                                           fluidRow(br(), 
                                                                                                    uiOutput("genesAvail"), 
                                                       ...
                                                       mainPanel(hr(),
                                                                 fluidRow(div(style="margin-left: 160px; margin-right: 160px", p("Differential expression results for individual microarray and RNA-Sequencing study were obtained using ",
                                                                          ...
                                                                          #column(12, HTML("<div style='height: 90px;'>"), imageOutput("color_scale1"), align="center", HTML("</div>")),
                                                                          column(10, withSpinner(plotOutput(outputId="forestplot_asthma",width="1355px", height="auto"),color= "#9E443A"), align="center"), 
                                                                          ...
                                                                          #conditionalPanel(condition = "input.Treatment != ''", 
                                                                          column(10, br(), br(), withSpinner(plotOutput(outputId="forestplot_GC",width="1355px", height="auto"),color= "#9E443A"),align="center"),
                                    ...
                                    tabPanel("References",
                                             column(12,align="left",
                                                    fluidRow(p("If you use REALGAR in your research, please cite the following papers:"),br(),
                                                             ...
                                                             p("Kan M, Shumyatcher M, Diwadkar A, Soliman G, Himes BE.", a("Integration of Transcriptomic Data Identifies Global and 
                                                               ...
                                                               Published 2018 Dec 5. (PMID:", a("30815178).",href="https://www.ncbi.nlm.nih.gov/pubmed/30815178", target="_blank"),"You can refer to the code",a("here.",href="https://github.com/HimesGroup/raved", target="_blank"))))))))
