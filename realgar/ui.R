...
ui <- shinyUI(fluidPage(theme = shinytheme("lumen"),
                        ...
                        p("This app was created by Maya Shumyatcher, Mengyuan Kan and Blanca Himes at the ", 
                          a("Himes Lab", href="http://himeslab.org/", target="_blank"),"."), 
                        p("NOTE: Please do not make selections while the application is loading.",style = "color: #9E443A;"),br(),
                                             ...
                                             wellPanel(fluidRow(align = "left",
                                                                column(12,  
                                                                       ...
                                                                       fluidRow(div(style="margin-right: 25px", 
                                                                                    ...
                                                                                    column(2,
                                                                                           fluidRow(pickerInput("Asthma",label = strong("Disease:"),choices = c("Asthma-Affection Status","Asthma-Endotypes"),multiple = TRUE,width="240px",selected=c("Asthma-Affection Status","Asthma-Endotypes"),options = list(`actions-Box` = TRUE,`none-Selected-Text` = "Select disease type(s)"))),
                                                                                    ...
                                                                                    column(3, 
                                                                                           fluidRow(checkboxGroupInput(inputId="Treatment", label=strong("Treatment:"), 
                                                                                                                          choices = c("Beta-agonist treatment"="BA", 
                                                                                                                                      ...
                                                                                                                                      "Smoking"="smoking", 
                                                                                                                                      "Vitamin D treatment"="vitD"), selected="GC")),
                                                       ...
                                                       mainPanel(hr(),
                                                                 fluidRow(br(),
                                                                          column(10, withSpinner(plotOutput(outputId="forestplot_asthma",width="925px", height="650px"),color= "#9E443A"), align="left"), 
                                                                          ...
                                                                          column(10, conditionalPanel(condition = "input.Treatment != ''", br(), br(), withSpinner(plotOutput(outputId="forestplot_GC",width="925px", height="650px"),color= "#9E443A")),align="left"),
