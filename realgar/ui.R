                                                                ...
                                                                column(12,  
                                                                       ...
                                                                       fluidRow(div(style="margin-right: 25px", 
                                                                                    ...
                                                                                    column(2,fluidRow(checkboxGroupInput(inputId="Asthma", label=strong("Condition vs Healthy:"),choices=asthma_choices,selected=asthma_choices)),
                                                                                           ...
                                                                                           fluidRow(checkboxGroupInput(inputId = "Status", label = strong("Restrict Age Group:"),choices=c("Children"="childhood"),selected="childhood"))),
                                                                                    ...
                                                                                    column(3, fluidRow(checkboxGroupInput(inputId="Treatment", label=strong("Treatment:"), choices = treatment_choices,selected=treatment_choices)),
                                                                                           ...
                                                                                           #fluidRow(br(), selectizeInput("current", label=strong("Select Gene Symbol or SNP ID:"), all_genes, selected="GAPDH", width="190px",options = list(create = TRUE)),tags$head(tags$style(type="text/css", "#curr_gene {width: 1090px}")),align="left")), 
                                                                                           fluidRow(br(), 
                                                                                                    uiOutput("genesAvail"), 
                                                                                    ...
                                                                                    column(2,
                                                                                           ...
                                                                                           fluidRow(uiOutput("TAGC_options"), conditionalPanel(condition = "output.TAGC_options=='-----------------------------------'", 
                                                                                                                                               selectInput("which_TAGC_pvals", "Which TAGC p-values to use?", 
                                                                                                                                                           ...
                                                                                                                                                           selected="p_ran_multi"))), align="left"))),br(),hr(),
                                                                                    ...
                                                                                    mainPanel(hr(),
                                                                                              fluidRow(div(style="margin-left: 160px; margin-right: 160px", 
                                                                                              p("Differential expression results for individual microarray and RNA-Sequencing study were obtained using ",
                                                                                                ...
                                                                                                column(10, div(style="margin-left: 150px",withSpinner(plotOutput(outputId="forestplot_asthma",width="1250px", height="auto"),color= "#9E443A")), align="center"), #1355px
                                                                                                ...
                                                                                                column(12, div(style="margin-left: 600px", textOutput("asthma_pcomb_text"), align="left")), # output combined p-values
                                                                                              #conditionalPanel(condition = "input.Asthma!= ''", 
                                                                                                column(12, div(style="margin-left: 650px",downloadButton(outputId="asthma_fc_download",label="Download asthma forest plot")), align="left"), 
                                                                                                #column(12, div(style="margin-left: 550px",uiOutput("asthma_fp_download")), align="left"), 
                                                                                                column(10, br(), br(), div(style="margin-left: 150px",withSpinner(plotOutput(outputId="forestplot_GC",width="1250px", height="auto"),color= "#9E443A")),align="center"),
                                                                                                ...
                                                                                                column(12, div(style="margin-left: 600px", textOutput("GC_pcomb_text"), align="left")), # output combined p-values
                                                                                                column(12, div(style="margin-left: 650px",downloadButton(outputId="GC_fc_download",label="Download GC forest plot")), align="left")), br(), hr(), width = 12,
                                                                                                                       
                                                                                                fluidRow(column(12, div(style="margin-left: 160px; margin-right: 160px", 
