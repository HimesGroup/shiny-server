...
regions_min_sf<-st_read("prevalencemaps/region_min_sf.shp")
location_min_sf<-st_read("prevalencemaps/location_min_sf.shp")

#Loading the names of the MMSAs for matching between BRFSS data and census shapefile data
mmsa_names<-read_feather("prevalencemaps/mmsa_names.feather")
polynamesnumbers<-read_feather("prevalencemaps/polynamesnumbers.feather")

#Reading in data for geographical plotting
weighted_current_asthma_prev <- read_feather("prevalencemaps/weighted_current_asthma_w_counts_leaflet.feather")
...
weighted_current_vars <- read_feather("prevalencemaps/weighted_current_variables_asthma_leaflet.feather")
...
weighted_current_chd_prev <- read_feather("prevalencemaps/weighted_current_chd_w_counts_leaflet.feather")
weighted_current_chd_prev$CHD_percent <- weighted_current_chd_prev$CHD*100

weighted_current_varschd <- read_feather("prevalencemaps/weighted_current_variables_chd_leaflet.feather")
...
weighted_current_flushot_prev <- read_feather("prevalencemaps/weighted_current_Flushot_w_counts_leaflet.feather")
weighted_current_flushot_prev$Flushot_percent <- weighted_current_flushot_prev$Flushot*100

weighted_current_varsflushot <- read_feather("prevalencemaps/weighted_current_variables_Flushot_leaflet.feather")
...
weighted_current_diabetes_prev <- read_feather("prevalencemaps/weighted_current_Diabetes_w_counts_leaflet.feather")
weighted_current_diabetes_prev$Diabetes_percent <- weighted_current_diabetes_prev$Diabetes*100

weighted_current_varsdiabetes <- read_feather("prevalencemaps/weighted_current_variables_Diabetes_leaflet.feather")
...
weighted_current_SRH_prev <- read_feather("prevalencemaps/weighted_current_SRH_w_counts_leaflet.feather")
weighted_current_SRH_prev$SRH_percent <- weighted_current_SRH_prev$SRH*100

weighted_current_varsSRH <- read_feather("prevalencemaps/weighted_current_variables_SRH_leaflet.feather")
...
weighted_current_HC_prev <- read_feather("prevalencemaps/weighted_current_HC_w_counts_leaflet.feather")
weighted_current_HC_prev$HC_percent <- weighted_current_HC_prev$HC*100

weighted_current_varsHC <- read_feather("prevalencemaps/weighted_current_variables_HC_leaflet.feather")
...
weighted_current_DEP_prev <- read_feather("prevalencemaps/weighted_current_DEP_w_counts_leaflet.feather")
weighted_current_DEP_prev$DEP_percent <- weighted_current_DEP_prev$DEP*100

weighted_current_varsDEP <- read_feather("prevalencemaps/weighted_current_variables_DEP_leaflet.feather")
...
weighted_current_COPD_prev <- read_feather("prevalencemaps/weighted_current_COPD_w_counts_leaflet.feather")
weighted_current_COPD_prev$COPD_percent <- weighted_current_COPD_prev$COPD*100

weighted_current_varsCOPD <- read_feather("prevalencemaps/weighted_current_variables_COPD_leaflet.feather")
...
weighted_current_YNSMOKE_prev <- read_feather("prevalencemaps/weighted_current_YNSMOKE_w_counts_leaflet.feather")
weighted_current_YNSMOKE_prev$YNSMOKE_percent <- weighted_current_YNSMOKE_prev$YNSMOKE*100

weighted_current_bmin_prev <- read_feather("prevalencemaps/weighted_current_bmin_w_counts_leaflet.feather")
weighted_current_bmin_prev$`Average BMI` <- weighted_current_bmin_prev$BMI_AVE

weighted_current_adi_prev <- read_feather("prevalencemaps/weighted_current_adi_w_counts_leaflet.feather")
...
current.all<-readRDS("prevalencemaps/current_all.RDS")
